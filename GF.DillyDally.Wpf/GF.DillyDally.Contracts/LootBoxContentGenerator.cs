...
namespace GF.DillyDally.Contracts
{
    public class LootBoxContentGenerator
    {
        ...
        public LootBoxContentGenerator()
        {
        }
        ...
        private Reward RandomSelectRewardFromBucket(IList<RewardTemplate> bucket, IReadOnlyList<Reward> selectedRewardsSoFar)
        {
        ...
        private static List<RewardTemplate> GetBucketWithoutExcludedRewards(IList<RewardTemplate> bucket, IReadOnlyList<Reward> rewards)
        {
