...
namespace GF.DillyDally.Mvvmc
{
    ...
    ///     Die beiden Event-Methoden werden deklariert, sowie eine Hilfsmethode SetAndRaiseIfChanged um den
    ...
    public class ObservableObject : INotifyPropertyChanged, INotifyPropertyChanging
    {
        ...
        protected bool SetAndRaiseIfChanged<T>(ref T field, T value, Expression<Func<T>> expression)
        {
            return this.SetAndRaiseIfChanged(ref field, value, expression, null);
        }

        protected bool SetAndRaiseIfChanged<T>(ref T field, T value, [CallerMemberName] string propertyName = null)
        {
            return this.SetAndRaiseIfChanged(ref field, value, propertyName, null);
        }
