...
namespace GF.DillyDally.Mvvmc.Validation
{
    public class ValidationSummary
    {
        ...
        {
            var keyValuePairs = validationResults as IList<KeyValuePair<IValidateable, ValidationResult>> ?? validationResults.ToList();
            ...
            this.UndeterminedResults = keyValuePairs.Where(m => m.Value.ValidationState == ValidationState.Undetermined).ToList();
        }
