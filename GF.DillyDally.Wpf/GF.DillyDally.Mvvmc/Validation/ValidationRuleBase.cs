...
{
    public abstract class ValidationRuleBase<TValidationObject> : IValidationRule<TValidationObject>
        where TValidationObject : class, IValidateable
    {
        ...
        #region Nested type: ValidateableReflector

        private static class ValidateableReflector
        {
            private static readonly Dictionary<Type, PropertyInfo[]> ItemTypeProperties =
