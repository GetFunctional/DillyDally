...
{
    internal sealed class OpenTasksListControllerHandler : IRequestHandler<OpenTasksListControllerRequest, TasksListController>
    {
        private readonly ControllerFactory<TasksListController> _tasksControllerFactory;
        private readonly ITasksRepository _tasksRepository;

        public OpenTasksListControllerHandler( ControllerFactory<TasksListController> tasksControllerFactory, ITasksRepository tasksRepository)
        {
            this._tasksControllerFactory = tasksControllerFactory;
            this._tasksRepository = tasksRepository;
        }

        public async Task<TasksListController> Handle(OpenTasksListControllerRequest request, CancellationToken cancellationToken)
        {
